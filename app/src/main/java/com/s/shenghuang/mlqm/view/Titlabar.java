...
public class Titlabar extends RelativeLayout implements View.OnClickListener{
    ...
    public void init(){
        ...
        LayoutParams Center_Textview_params=new LayoutParams(MacUtils.dpto((Activity) mContext,120),wrape_parent);
    ...
    //设置右边按钮背景或文字
    public void setRightBackground(int background,int radius) {
        GradientDrawable gradientDrawable=new GradientDrawable();
        gradientDrawable.setColor(background);
        gradientDrawable.setCornerRadius(MacUtils.dpto((Activity) mContext, radius));
        Right_Textview.setBackground(gradientDrawable);
    }
    ...
    public void setCenterDrawable(Drawable drawable){
        Center_Textview.setCompoundDrawables(drawable,null,null,null);
    }
    ...
    //设置图标与文字的距离
    public void setRight_drawable_padding(int padding){
        int pd=MacUtils.dpto((Activity) mContext,padding);
        Right_Textview.setCompoundDrawablePadding(pd);
    }
    //设置图标与文字的距离
    public void setLeft_drawable_padding(int padding){
        int pd=MacUtils.dpto((Activity) mContext,padding);
        Left_TextView.setCompoundDrawablePadding(pd);
    }
