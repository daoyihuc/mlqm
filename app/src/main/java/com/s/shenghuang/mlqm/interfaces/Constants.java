package com.s.shenghuang.mlqm.interfaces;
/**
 * 公共常量
 */
public interface Constants {

    String MAIN_URLS = "https://mlqms.shenghuang365.com/upload/";    //正式服务器主域名
    String MAIN_URL = "https://mlqms.shenghuang365.com/api/";    //正式服务器主域名
